...
from custom_components.frisquet_connect.domains.authentication.authentication_request import AuthenticationRequest
...
from custom_components.frisquet_connect.repositories.core_repository import do_get, do_post
...
class FrisquetConnectRepository:
    ...
    async def get_token_and_sites(self, email: str, password: str) -> Authentication:
    ...
    async def set_selector(self, site_id: str, zone_id: str, zone_selector: ZoneSelector, token: str) -> dict:
    ...
    async def set_exemption(self, site_id: str, zone_selector: ZoneSelector, token: str) -> dict:
    ...
    async def set_boost(self, site_id: str, zone_id: str, enable: bool, token: str) -> dict:
        LOGGER.debug("Setting exemption")
    ...
    async def _do_site_action(self, site_id: str, token: str, payload: list[dict]) -> dict:
