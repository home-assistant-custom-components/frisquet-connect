...
from custom_components.frisquet_connect.domains.site.zone_detail import ZoneDetail
from custom_components.frisquet_connect.domains.site.zone_scheduler import ZoneScheduler
