...
@pytest.mark.asyncio
async def test_async_config_flow_step_site(mock_hass: HomeAssistant, mock_entry: ConfigEntry):
    config_flow = FrisquetConnectFlow()
...
@pytest.mark.asyncio
async def test_async_config_flow_all_step(mock_hass: HomeAssistant, mock_entry: ConfigEntry):
    config_flow = FrisquetConnectFlow()
