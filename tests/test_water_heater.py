...
from custom_components.frisquet_connect.entities.water_heater.default_water_heater import DefaultWaterHeaterEntity
from custom_components.frisquet_connect.water_heater import async_setup_entry
